package it.fedet.minigames.world.importer;

import com.flowpowered.nbt.*;
import com.flowpowered.nbt.stream.NBTInputStream;
import it.fedet.minigames.api.world.exception.InvalidWorldException;
import it.fedet.minigames.utils.NibbleArray;
import it.fedet.minigames.world.importer.data.LevelData;
...
public class WorldImporter {
    ...
    public static CraftSlimeWorld readFromDirectory(File worldDir) throws InvalidWorldException, IOException {
        ...
        return new CraftSlimeWorld(null, worldDir.getName(), chunks, new CompoundTag("", extraData),
                maps, worldVersion, propertyMap, false, false, true);
    }
    ...
    private static SlimeChunk readChunk(CompoundTag compound, byte worldVersion) {
        ...
        CraftSlimeChunkSection[] sectionArray = new CraftSlimeChunkSection[16];
        ...
        for (CraftSlimeChunkSection section : sectionArray) {
    ...
    private static class ChunkEntry {
        ...
        private ChunkEntry(int offset, int paddedSize) {
            this.offset = offset;
