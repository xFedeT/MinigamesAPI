...
package it.fedet.minigames.world.service.world.importer;

import com.flowpowered.nbt.*;
import com.flowpowered.nbt.stream.NBTInputStream;
import it.fedet.minigames.api.world.exceptions.InvalidWorldException;
        ...
        if (levelFile.exists() && levelFile.isFile()) {
            ...
            if (regionDir.exists() && regionDir.isDirectory()) {
                ...
                if (chunks.isEmpty()) {
                    ...
                    propertyMap.setInt(WorldProperties.SPAWN_X, data.spawnX());
                    propertyMap.setInt(WorldProperties.SPAWN_Y, data.spawnY());
                    propertyMap.setInt(WorldProperties.SPAWN_Z, data.spawnZ());
