...
public class CraftSlimeWorld implements SlimeWorld {
    ...
    public SlimeWorld.SlimeProperties getProperties() {
        return SlimeProperties.builder()
                .spawnX(this.propertyMap.getInt(WorldProperties.SPAWN_X))
                .spawnY(this.propertyMap.getInt(WorldProperties.SPAWN_Y))
                .spawnZ(this.propertyMap.getInt(WorldProperties.SPAWN_Z))
                .environment(this.propertyMap.getString(WorldProperties.ENVIRONMENT))
                .pvp(this.propertyMap.getBoolean(WorldProperties.PVP))
                .allowMonsters(this.propertyMap.getBoolean(WorldProperties.ALLOW_MONSTERS))
                .allowAnimals(this.propertyMap.getBoolean(WorldProperties.ALLOW_ANIMALS))
                .difficulty(Difficulty.valueOf(this.propertyMap.getString(WorldProperties.DIFFICULTY).toUpperCase()).getValue())
    ...
    public byte[] serialize() {
        ...
        try {
            outStream.write(WorldFormat.HEADER);
            outStream.write(9);
    ...
    public WorldPropertyMap getPropertyMap() {
    ...
    public CraftSlimeWorld(SlimeLoader loader, String name, Map<Long, SlimeChunk> chunks, CompoundTag extraData, List<CompoundTag> worldMaps, byte version, WorldPropertyMap propertyMap, boolean readOnly, boolean ignoreLocked, boolean locked) {
        this.loader = loader;
        this.name = name;
        this.chunks = chunks;
