...
public class Converter {
    ...
    static net.minecraft.server.v1_8_R3.NibbleArray convertArray(it.fedet.minigames.api.swm.utils.NibbleArray array) {
        return new net.minecraft.server.v1_8_R3.NibbleArray(array.getBacking());
    }

    static it.fedet.minigames.api.swm.utils.NibbleArray convertArray(net.minecraft.server.v1_8_R3.NibbleArray array) {
